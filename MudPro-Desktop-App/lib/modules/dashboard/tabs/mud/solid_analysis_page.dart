...
class _SolidAnalysisDialogState extends State<SolidAnalysisDialog> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // Manual refresh
                Obx(
                  () => c.isSolidAnalysisLoading.value
                      ? const SizedBox(
                          width: 18,
                          height: 18,
  ...
  Widget _body() {
    return Padding(
      ...
      child: Obx(() {
        if (c.solidAnalysisError.isNotEmpty &&
            !c.isSolidAnalysisLoading.value) {
          return _errorState();
        }
          ...
          child: Column(
            children: List.generate(
              ...
              (i) => Container(
                ...
                child: Row(
                  children: [_skel(width: 170), _skel(), _skel(), _skel()],
                ),
              ),
            ),
          ),
