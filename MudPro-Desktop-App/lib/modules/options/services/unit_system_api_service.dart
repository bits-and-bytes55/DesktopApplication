...
class UnitSystemApiService {
  ...
  Future<UnitSystemListResponse> fetchAll() async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl${ApiEndpoint.unitSystems}'),
        headers: _headers,
      );
  ...
  Future<UnitSystemResponse> updateAll({
    ...
    try {
      final response = await http.put(
        Uri.parse('$baseUrl${ApiEndpoint.unitSystems}/$id'),
        headers: _headers,
  ...
  Future<bool> patchParameterUnit({
    ...
    try {
      final response = await http.patch(
        Uri.parse('$baseUrl${ApiEndpoint.unitSystems}/$systemId/parameter/$paramNumber'),
        headers: _headers,
  ...
  Future<UnitSystemListResponse> seedDefaultSystems() async {
    try {
      final response = await http.post(
        Uri.parse('$baseUrl${ApiEndpoint.seedUnitSystems}'),
        headers: _headers,
      );
