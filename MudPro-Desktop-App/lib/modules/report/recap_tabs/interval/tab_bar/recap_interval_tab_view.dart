...
const Color _intervalOuterBorder = Color(0xFFB8D0EA);
const Color _intervalCanvas = Color(0xFFF4F6FA);
const Color _intervalPanelBorder = Color(0xFFB8D0EA);
const Color _intervalHeaderFill = Color(0xFFEAF3FC);
const Color _intervalText = Color(0xFF1C1C1C);
const Color _intervalGrid = Color(0xFFCFE0F2);
const Color _intervalTabFill = Color(0xFFEAF3FC);
