...
const Color _dailyCostOuterBorder = Color(0xFFB8D0EA);
const Color _dailyCostCanvas = Color(0xFFF4F6FA);
const Color _dailyCostPanelBorder = Color(0xFFB8D0EA);
const Color _dailyCostHeaderFill = Color(0xFFEAF3FC);
const Color _dailyCostText = Color(0xFF1C1C1C);
const Color _dailyCostGrid = Color(0xFFCFE0F2);
const Color _dailyCostTabFill = Color(0xFFEAF3FC);
