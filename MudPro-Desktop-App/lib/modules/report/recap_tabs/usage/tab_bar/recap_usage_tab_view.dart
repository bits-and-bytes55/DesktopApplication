...
const Color _usageOuterBorder = Color(0xFFB8D0EA);
const Color _usageCanvas = Color(0xFFF4F6FA);
const Color _usagePanelBorder = Color(0xFFB8D0EA);
const Color _usageHeaderFill = Color(0xFFEAF3FC);
const Color _usageText = Color(0xFF1C1C1C);
const Color _usageGrid = Color(0xFFCFE0F2);
const Color _usageTabFill = Color(0xFFEAF3FC);
