...
const Color _hydraulicsOuterBorder = Color(0xFFB8D0EA);
const Color _hydraulicsCanvas = Color(0xFFF4F6FA);
const Color _hydraulicsPanelBorder = Color(0xFFB8D0EA);
const Color _hydraulicsHeaderFill = Color(0xFFEAF3FC);
const Color _hydraulicsText = Color(0xFF1C1C1C);
const Color _hydraulicsGrid = Color(0xFFCFE0F2);
const Color _hydraulicsTabFill = Color(0xFFEAF3FC);
