...
const Color _solidsOuterBorder = Color(0xFFB8D0EA);
const Color _solidsCanvas = Color(0xFFF4F6FA);
const Color _solidsPanelBorder = Color(0xFFB8D0EA);
const Color _solidsHeaderFill = Color(0xFFEAF3FC);
const Color _solidsText = Color(0xFF1C1C1C);
const Color _solidsGrid = Color(0xFFCFE0F2);
const Color _solidsTabFill = Color(0xFFEAF3FC);
