...
import 'package:mudpro_desktop_app/modules/report/recap_tabs/drilling_data/tabs/drilling_data_graph.dart';
import 'package:mudpro_desktop_app/modules/report/recap_tabs/drilling_data/tabs/drilling_data_table.dart';
          ...
          Expanded(
            child: Container(
              ...
              child: TabBarView(
                controller: _tabController,
                children: [
                  const DrillingDataTable(),
                   RecapDrillingDataGraphPage(),
                ],
              ),
            ),
          ),
