...
const Color _cumCostOuterBorder = Color(0xFFB8D0EA);
const Color _cumCostCanvas = Color(0xFFF4F6FA);
const Color _cumCostPanelBorder = Color(0xFFB8D0EA);
const Color _cumCostHeaderFill = Color(0xFFEAF3FC);
const Color _cumCostText = Color(0xFF1C1C1C);
const Color _cumCostGrid = Color(0xFFCFE0F2);
const Color _cumCostTabFill = Color(0xFFEAF3FC);
