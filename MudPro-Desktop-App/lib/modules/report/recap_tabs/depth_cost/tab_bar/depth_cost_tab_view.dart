...
const Color _depthCostOuterBorder = Color(0xFF2F92E8);
const Color _depthCostCanvas = Color(0xFFF4F4F4);
const Color _depthCostPanelBorder = Color(0xFFC8C8C8);
const Color _depthCostHeaderFill = Color(0xFFF7F7F7);
const Color _depthCostText = Color(0xFF1C1C1C);
const Color _depthCostGrid = Color(0xFFD7D7D7);
const Color _depthCostTabFill = Color(0xFFEAEAEA);
