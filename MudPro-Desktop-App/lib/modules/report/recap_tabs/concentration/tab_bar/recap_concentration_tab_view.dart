...
const Color _concentrationOuterBorder = Color(0xFFB8D0EA);
const Color _concentrationCanvas = Color(0xFFF4F6FA);
const Color _concentrationPanelBorder = Color(0xFFB8D0EA);
const Color _concentrationHeaderFill = Color(0xFFEAF3FC);
const Color _concentrationText = Color(0xFF1C1C1C);
const Color _concentrationGrid = Color(0xFFCFE0F2);
const Color _concentrationTabFill = Color(0xFFEAF3FC);
