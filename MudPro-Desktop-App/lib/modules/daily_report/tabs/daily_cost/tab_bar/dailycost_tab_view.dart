...
class DailyCostTabView extends StatefulWidget {
  const DailyCostTabView({super.key});

  @override
  State<DailyCostTabView> createState() => _DailyCostTabViewState();
}

class _DailyCostTabViewState extends State<DailyCostTabView> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children:  [
                /// ✅ PRODUCTS TAB
                DailyCostProductsPage(),

                /// CATEGORIES TAB
                 DailyCostOtherTab(),

                /// USAGE TABLE TAB
                DailyCostTableUsagePage(),
