...
class DailyCostProductsPage extends StatelessWidget {
  const DailyCostProductsPage({super.key});
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: HorizontalCostChart(
                      title: 'Daily Cost Distribution - Products',
                      data: productData,
                      maxValue: 100,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: HorizontalCostChart(
                      title: 'Daily Cost Distribution - Categories',
                      data: groupData,
                      maxValue: 100,
                      showValues: false, // Legend hidden to save space
                    ),
