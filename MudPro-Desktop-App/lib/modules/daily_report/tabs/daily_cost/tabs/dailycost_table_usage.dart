...
class _DailyCostTableUsagePageState extends State<DailyCostTableUsagePage> {
      ...
      if (data.isEmpty) {
        setState(() {
          ...
          _emptyMessage =
              ...
              : 'No inventory snapshot data is available for the selected well.';
          _isLoading = false;
        });
        return;
      }
  ...
  Widget _buildTable() {
    ...
    for (final cat in categories) {
      ...
      categoryBlocks.add(_buildCategoryBlock(cat, items, globalRowIndex));
