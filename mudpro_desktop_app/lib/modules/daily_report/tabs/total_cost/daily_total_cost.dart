...
class DailyTotalCostPage extends StatefulWidget {
  const DailyTotalCostPage({super.key});

  @override
  State<DailyTotalCostPage> createState() => _DailyTotalCostPageState();
}

class _DailyTotalCostPageState extends State<DailyTotalCostPage>
          ...
          Expanded(
            child: Container(
              ...
              child: TabBarView(
                controller: _tabController,
                children: const [
                  DailyTotalCostTableTab(),
                  DailyTotalCostGraphTab(),
                ],
              ),
            ),
          ),
